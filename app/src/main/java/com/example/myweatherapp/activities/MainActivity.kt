...
class MainActivity : AppCompatActivity() {
    ...
    val mainDescription=findViewById<TextView>(R.id.tv_main_description)
    ...
    val tvSunrise=findViewById<TextView>(R.id.tv_sunrise_time)
    val tvSunset=findViewById<TextView>(R.id.tv_sunset_time)
    ...
    private fun setupUI() {
        ...
        if (!weatherResponseJsonString.isNullOrEmpty()) {
            ...
            for (z in weatherList.weather.indices) {
                ...
                mainDescription.text = weatherList.weather[z].description
                tvTemp.text =
                ...
                tvSunrise.text = unixTime(weatherList.sys.sunrise.toLong())
                tvSunset.text = unixTime(weatherList.sys.sunset.toLong())
